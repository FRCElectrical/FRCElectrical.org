...
## Using Your Robot as a Tool
- We write up most of our course with supplementing images. Getting across all of the elements of FRC electrical to your students on an actual FRC robot may be easier, though, as this allows for a way to connect information together and allows for a better way for your students to ask questions. Thus we recommend using a robot or a test bench for in person learning.
- Just one robot can be used to teach electrical theory, the control system, specific parts that your team uses, and mechanism wiring. We recommend you structure the way you teach your students in a fashion similar to our course.  

### Project
- Have your students make a diagram that has all of the core electronics + more, maybe on a sample robot. 
    - RoboRIO/Systemcore
    - PDH
    - Battery
    - Radio
